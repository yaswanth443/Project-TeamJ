...
@Component({
  selector: 'app-customer-dashboard-live-dialog',
  templateUrl: './customer-dashboard-live-dialog.component.html',
  styleUrls: ['./customer-dashboard-live-dialog.component.scss']
})
export class CustomerLiveDialogComponent implements OnInit{
