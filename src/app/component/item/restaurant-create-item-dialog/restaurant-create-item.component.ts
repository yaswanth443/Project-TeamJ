...
@Component({
  selector: 'app-restaurant-create-item',
  templateUrl: './restaurant-create-item.component.html',
  styleUrls: ['./restaurant-create-item.component.scss']
})
export class RestaurantCreateItemComponent implements OnInit {
  ...
  constructor(private _sharedService: SharedService,
    public dialogRef: MatDialogRef<RestaurantCreateItemComponent>) {
  }
  ...
  submit() {
    ...
    this._sharedService.post(AppConstants.GET_RESTAURANT_ITEMS_LOGGED, this.myForm.value)//same url for post service as well
      .subscribe(res => {
